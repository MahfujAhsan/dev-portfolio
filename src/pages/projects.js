        ...
        <article className='w-full flex items-center justify-between rounded-3xl border border-solid border-dark bg-light shadow-2xl p-12 relative rounded-br-2xl dark:bg-dark dark:border-light'>
            ...
            <div className='w-1/2 flex flex-col items-start justify-between pl-6'>
                ...
                <div className='mt-2 flex items-center'>
                    ...
                    <Link className='ml-4 rounded-lg bg-dark text-light p-2 px-6 text-lg font-semibold dark:bg-light dark:text-dark' href={link} target='_blank'>
                        Visit Project
                    </Link>
                </div>
            </div>
...
const Project = ({ title, type, img, link, github }) => {
    return (
        <article className='w-full flex flex-col items-start justify-between rounded-2xl border border-solid border-dark bg-light p-6 relative dark:bg-dark dark:border-light'>
            ...
            <div className='w-full flex flex-col items-start justify-between mt-4'>
                ...
                <Link href={link} target='_blank' className='hover:underline underline-offset-2'>
                    <h2 className='my-2 text-left w-full text-3xl font-bold'>{title}</h2>
                </Link>
